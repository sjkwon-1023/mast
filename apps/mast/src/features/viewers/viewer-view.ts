// 뷰어 탭 뷰의 공통 계약 (21단계 청크 C1) — features/viewers/folder/view.ts 가 구현하고,
// features/viewers/text/view.ts(C2)·features/viewers/markdown/view.ts(D)가 뒤따른다.
//
...
import type { TabKind, TerminalStatus } from "../../shared/types";
