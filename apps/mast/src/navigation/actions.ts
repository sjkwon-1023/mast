...
import type { KeyAction, PaneRect } from "../keys";
import { logSwallowedShortcut } from "../logging";
import { adjustFontSize, resetFontSize } from "../terminal/settings";
import { adjustViewerFontSize, resetViewerFontSize } from "../viewer-font";
