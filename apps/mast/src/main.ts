...
import { activeTerminalCwd, activeWorkspace, pathBasename } from "./keys";
...
import { applyTerminalSettings } from "./terminal/settings";
import { applyHighlightSettings } from "./text/settings";
